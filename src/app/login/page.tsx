      ...
      <div className="w-full max-w-sm">
        ...
        >
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-2.5 bg-[#076292] hover:bg-[#054e73] disabled:opacity-70 disabled:cursor-not-allowed text-white font-semibold rounded-xl text-sm transition-colors"
          >
            {loading ? (
